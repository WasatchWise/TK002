    ...
    <footer className="bg-slctrips-navy text-center py-6 border-t-4 border-slctrips-gold">
      <div className="container mx-auto px-4">
        <p className="text-slctrips-mid text-sm">
          SLCTrips &copy; 2025. All rights reserved.
        </p>
        ...
        <p className="text-gray-500 text-xs mt-2">
          Information such as park fees and hours are subject to change. Please verify details before your trip. Content last reviewed September 2025.
        </p>
      </div>
    </footer>
  );
