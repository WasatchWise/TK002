...
const DestinationListPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="font-heading text-5xl font-bold text-center text-slctrips-navy mb-4">Destination Catalog</h1>
      <p className="text-center text-gray-600 mb-8 max-w-2xl mx-auto">
        Browse our collection of curated adventures. Select a category to focus your search or explore the entire atlas of the American West.
      </p>
      ...
      {error && <p className="text-center text-slctrips-red">{error}</p>}
      {!isLoading && !error && (
